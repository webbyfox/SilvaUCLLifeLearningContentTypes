...
# Others
from interfaces import IAnouncement, IAnouncementVersion
...
class Anouncement(CatalogedVersionedContent):
    """
    Simple Course type object for Course object
    """
    implements(IAnouncement)
    security = ClassSecurityInfo()
    meta_type = "Anouncement"
    __doc__ = "Anouncement object"
    ...
    def save_title_and_metadata(self, html):
        ...
        if IAnouncementVersion.providedBy(version):
...
class AnouncementVersion(CatalogedVersion):           
    """Base class for course object versions
    """        
    implements(IAnouncementVersion)
    security = ClassSecurityInfo()
    meta_type = "Anouncement Version"

    def __init__(self,id):
        super(AnouncementVersion, self).__init__(id)
...
InitializeClass(Anouncement)
InitializeClass(AnouncementVersion)
